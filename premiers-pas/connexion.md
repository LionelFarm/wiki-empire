...
\
1: Quand tu vas entrer l'IP du serveur, tu devras créer un mot de passe et le confirmer. ( attention tu as 15 secondes pour terminer l'action sinon ça te kik. )
